...
//Name: mayan_chair.ma
//Last modified: Fri, Oct 22, 2021 05:12:43 PM
//Codeset: 1252
requires maya "2022";
requires "mtoa" "4.2.3";
requires "mtoa" "4.2.3";
currentUnit -l centimeter -a degree -t film;
fileInfo "exportedFrom" "F:/Nauji Files/GitHub/clean-up/Clean-Up!/Assets/Meshes/Clean_Up_Chair_4.ma";
fileInfo "application" "maya";
fileInfo "product" "Maya 2022";
fileInfo "version" "2022";
fileInfo "cutIdentifier" "202106180615-26a94e7f8c";
fileInfo "osv" "Windows 10 Home v2009 (Build: 19043)";
fileInfo "UUID" "565DC026-469D-3C49-AB39-ED914D19DD8D";
createNode transform -n "pCylinder2";
	rename -uid "C7B78033-4A8A-070A-D258-D79ADA1AA9AF";
	setAttr ".t" -type "double3" 9.1223639434676826 6.782858593555904 -46.995675134914848 ;
	setAttr ".rp" -type "double3" 0.15795253217220306 25.553615570068356 -12.134462356567383 ;
	setAttr ".sp" -type "double3" 0.15795253217220306 25.553615570068356 -12.134462356567383 ;
createNode mesh -n "pCylinder2Shape" -p "pCylinder2";
	...
	setAttr -s 206 ".uvst[0].uvsp[0:205]" -type "float2" 0.28113416 0.08604788
		 ...
		 0.31006402 0.32700628 0.28113416 0.08604788 0.31069905 0.29205766 0.055333912 0.26120377
		 0.055333912 0.26120377 0.055333912 0.26120377 0.69967932 0.050312284 -0.83865207
		 0.48008084 -0.24004024 0.68519878;
...
createNode transform -s -n "persp";
	...
	setAttr ".v" no;
	setAttr ".t" -type "double3" 65.310962942570825 54.058926649089855 -25.335822804567897 ;
	setAttr ".r" -type "double3" -18.33835272960723 63.400000000001754 -3.5516361005820312e-15 ;
createNode camera -s -n "perspShape" -p "persp";
	rename -uid "90A0102B-4A9C-FBF8-506D-6D99ADC4A17F";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999993;
	setAttr ".coi" 63.872167915536714;
...
createNode transform -s -n "top";
	...
	setAttr ".v" no;
	setAttr ".t" -type "double3" 3.1624717450169646 1000.1 -59.11833450892702 ;
...
createNode transform -s -n "front";
	...
	setAttr ".v" no;
	setAttr ".t" -type "double3" 2.3096923304586241 33.137069844049421 1000.1 ;
createNode camera -s -n "frontShape" -p "front";
	rename -uid "7FF7143A-42E4-E1C4-8DDD-1AA62BD31D25";
	setAttr -k off ".v" no;
	setAttr ".rnd" no;
	setAttr ".coi" 1000.1;
	setAttr ".ow" 69.185446789396011;
...
createNode transform -s -n "side";
	...
	setAttr ".v" no;
	setAttr ".t" -type "double3" 1000.1 32.975403029478301 -52.35293156343144 ;
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "F7B6D8C5-4B62-71B7-FF8F-2A8E42C4760F";
	setAttr -s 4 ".lnk";
	setAttr -s 4 ".slnk";
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "5D060A57-4D6E-2D55-0186-0680263C33D7";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "C7671A33-463F-B432-5703-79867D80A456";
createNode displayLayerManager -n "layerManager";
	rename -uid "58C3850A-43C7-0F29-A134-C9B9E3C44E1E";
createNode displayLayer -n "defaultLayer";
	rename -uid "46C9C241-4EC0-CC10-DED9-9B9F2482756E";
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "981FD836-4C22-7D6B-E29C-539A46293350";
